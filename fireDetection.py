...
def send_mail_function(): # defined function to send mail post fire detection using threading
    ...
    recipientmail = "rlucky540@gmail.com" # recipients mail
    ...
    try:
        ...
        server.ehlo()
        server.starttls()
        server.login("praveenlingala378@gmail.com", '9740699375') # Senders mail ID and password
        server.sendmail('rlucky540@gmail.com', recipientmail, "Warning fire accident has been reported") # recipients mail with mail message
